...
export default function AguaContador({ copos, setCopos, metaCopos }) {
    const { theme } = useTheme();
    const [consumidos, setConsumidos] = useState(0); // Agora 'useState' está funcionando corretamente

    const adicionarCopo = () => {
      setConsumidos(consumidos + 1);
    };
